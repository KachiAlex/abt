-- Initial Database Schema for ABT Project Tracker
...
CREATE TABLE IF NOT EXISTS projects (
  ...
  lga TEXT, -- Can be TEXT or TEXT[] for multiple LGAs (stored as JSON)
  ...
  location JSONB, -- Store location as JSONB for flexibility
